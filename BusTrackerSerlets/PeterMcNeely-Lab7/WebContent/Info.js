...
function requestSystemInfo() {
    ...
    window.history.pushState("","System Info", "Info.html?info=system");
}
...
function requestHTTPHeaders(){
    ...
    window.history.pushState("","HTTP headers", "Info.html?info=headers");
}
...
function requestParams(){
    ...
    window.history.pushState("","System Info", "Info.html?info=params&day=Thursday&course=se2840&school=msoe&firstname=Peter&lastname=McNeely");
...
function requestInfo(){
    ...
    window.history.pushState("","Request Info", "Info.html?info=request");
}
...
/**
 * Displays the paramerters that are sent back from the servlet
 * @param response the 
 * @param textStatus
 * @param jqXHR
 * @returns
